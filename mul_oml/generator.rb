...
is doing and useful for.
  ...
  app.defProperty('dpid', 'Create periodic result', '-dpid',
        :type => :string, :mnemonic => 'l')
...
/
  ...
  app.defMeasurement("switch") do |mp|
    mp.defMetric('list', :string)
#    mp.defMetric('inverse', :double)
  end

  # Declare a giant Measurement Point showing all supported types
  app.defMeasurement("flow") do |mp|
    mp.defMetric('entries', :string)
